export default function HealthBar({
  ...
  return (
    <div className={`z-10 absolute w-[150px] ${partyMember ? "mt-24" : ""}`}>
      <div className={`flex w-[150px] flex-row justify-between`}>
        <div className={`ml-2 text-black font-bold`}>{character.name}</div>
        <div className={`text-black font-bold`}>Lvl {character.level}</div>
      </div>
      <div className={`w-[150px] h-4 bg-black flex flex-row`}>
