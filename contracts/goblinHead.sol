...
contract GoblinHead is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 10000; // Max supply of collection
    uint private constant TOKENS_RESERVED = 5; // When smart contract is deployed, '5' will be minted to my wallet
    uint public price = 100000000000000000; // in wei, equal to 1 ETH
    uint256 public constant MAX_MINT_PER_TX = 10; // Can mint 1 - 10 per transaction

    bool public isSaleActive; //True if public sale is currently going on
    uint256 public totalSupply;
    mapping(address => uint256) private mintedPerWallet;// How many NFTs minted per wallet

    string public baseUri;
    string public baseExtension = ".json";

    constructor() ERC721("Grakk'thul") {
